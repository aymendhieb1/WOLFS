...
public class Session {
    ...
    public Session(int id_sess, LocalDate date_sess, LocalTime time_sess, int cap_sess, int nbr_places_sess) {
    ...
    public Session( LocalDate date_sess, LocalTime time_sess, int cap_sess, int nbr_places_sess) {
        this.id_sess = id_sess;
        this.date_sess = date_sess;
        this.time_sess = time_sess;
        this.cap_sess = cap_sess;
